...
class tutorial_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutorial_test")
        ...
        self.samp_rate_1 = samp_rate_1 = 3.84e6
        ...
        self._samp_rate_1_range = Range(192e3, 56e6, 1e3, 3.84e6, 200)
        self._samp_rate_1_win = RangeWidget(self._samp_rate_1_range, self.set_samp_rate_1, 'Sample Rate', "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_0.set_bandwidth(samp_rate_1, 0)
    ...
    def set_tuning(self, tuning):
        self.tuning = tuning
        self.qtgui_sink_x_0.set_frequency_range(self.tuning, self.samp_rate_1)
    ...
    def set_samp_rate_1(self, samp_rate_1):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.tuning, self.samp_rate_1)
        self.uhd_usrp_source_0.set_bandwidth(self.samp_rate_1, 0)
...
def main(top_block_cls=tutorial_test, options=None):
